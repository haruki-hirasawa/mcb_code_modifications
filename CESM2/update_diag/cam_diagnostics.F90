...
!==============================================================================
  ...
  subroutine diag_init_dry(pbuf2d)
    ...
    call addfld ('UZ',         (/ 'lev' /), 'A', 'm2/s',      'Zonal transport of geopotential height')
...
!===============================================================================
  ...
  subroutine diag_phys_writeout_dry(state, pbuf, p_surf_t)
    ...
    ftem(:ncol,:) = z3(:ncol,:)*state%u(:ncol,:)
    call outfld ('UZ      ',ftem,  pcols,lchnk)
       
    ftem(:ncol,:) = state%q(:ncol,:,1)*state%u(:ncol,:)
    call outfld ('UQ      ',ftem,  pcols,lchnk)

    ftem(:ncol,:) = state%t(:ncol,:)*state%u(:ncol,:)
